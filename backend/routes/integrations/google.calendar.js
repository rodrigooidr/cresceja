...
r.post('/integrations/google-calendar/events', handleCreateEvent);
r.delete('/integrations/google-calendar/events/:id', handleDeleteEvent);
r.get('/integrations/google-calendar/logs', handleListLogs);
r.post('/integrations/google-calendar/propose-slots', handleProposeSlots);

r.get('/api/integrations/google/calendar/status', (_req, res) => {
  return res.status(200).json({ connected: false, account_email: null });
});

r.post('/api/integrations/google/calendar/propose-slots', handleProposeSlots);
r.post('/api/integrations/google/calendar/events', handleCreateEvent);
r.delete('/api/integrations/google/calendar/events/:id', handleDeleteEvent);
r.get('/api/integrations/google/calendar/logs', handleListLogs);
